...
func TestConsumeSignatureVerificationGas(t *testing.T) {
	...
	for i := 0; i < len(pkSet1); i++ {
		stdSig := legacytx.StdSignature{PubKey: pkSet1[i], Signature: sigSet1[i]} //nolint:staticcheck // SA1019: legacytx.StdSignature is deprecated: use the proto TxBody and TxRaw types
