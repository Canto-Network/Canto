...
type CSR struct {
	...
	Revenue []byte `protobuf:"bytes,4,opt,name=revenue,proto3" json:"revenue,omitempty"`
}
...
var fileDescriptor_57c53cea3d443afa = []byte{
	...
	0x42, 0x1f, 0xc4, 0x82, 0xa8, 0x51, 0x8a, 0xe7, 0x62, 0x76, 0x0e, 0x0e, 0x12, 0x92, 0xe1, 0xe2,
	...
	0x65, 0xa6, 0x08, 0x09, 0x70, 0x31, 0x97, 0x54, 0x14, 0x4b, 0x30, 0x83, 0x05, 0x40, 0x4c, 0x21,
	0x09, 0x2e, 0xf6, 0xa2, 0xd4, 0xb2, 0xd4, 0xbc, 0xd2, 0x54, 0x09, 0x16, 0x05, 0x46, 0x0d, 0x9e,
	0x20, 0x18, 0xd7, 0xc9, 0xfd, 0xc4, 0x23, 0x39, 0xc6, 0x0b, 0x8f, 0xe4, 0x18, 0x1f, 0x3c, 0x92,
	0x63, 0x9c, 0xf0, 0x58, 0x8e, 0xe1, 0xc2, 0x63, 0x39, 0x86, 0x1b, 0x8f, 0xe5, 0x18, 0xa2, 0x74,
	0xd3, 0x33, 0x4b, 0x32, 0x4a, 0x93, 0xf4, 0x92, 0xf3, 0x73, 0xf5, 0x9d, 0x41, 0x2e, 0xd5, 0xf5,
	0x4b, 0x2d, 0x29, 0xcf, 0x2f, 0xca, 0x86, 0xf0, 0xf4, 0xcb, 0x8c, 0xf4, 0x2b, 0xc0, 0x9e, 0x2a,
	0xa9, 0x2c, 0x48, 0x2d, 0x4e, 0x62, 0x03, 0x3b, 0xd8, 0x18, 0x10, 0x00, 0x00, 0xff, 0xff, 0xdf,
	0x35, 0x30, 0x2d, 0xee, 0x00, 0x00, 0x00,
}
...
func (m *CSR) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.Revenue) > 0 {
		...
		i = encodeVarintCsr(dAtA, i, uint64(len(m.Revenue)))
		i--
		dAtA[i] = 0x22
	}
	if m.Txs != 0 {
...
func (m *CSR) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 4:
			...
			m.Revenue = append(m.Revenue[:0], dAtA[iNdEx:postIndex]...)
			if m.Revenue == nil {
				m.Revenue = []byte{}
			}
			iNdEx = postIndex
