...
type MsgUpdateCSR struct {
	...
	PoolAddress github_com_cosmos_cosmos_sdk_types.AccAddress `protobuf:"bytes,2,opt,name=pool_address,json=poolAddress,proto3,customtype=github.com/cosmos/cosmos-sdk/types.AccAddress" json:"pool_address"`
...
type MsgWithdrawCSR struct {
	...
	CsrPools []github_com_cosmos_cosmos_sdk_types.AccAddress `protobuf:"bytes,1,rep,name=csr_pools,json=csrPools,proto3,customtype=github.com/cosmos/cosmos-sdk/types.AccAddress" json:"csr_pools,omitempty"`
...
var fileDescriptor_249005a6451fe2d1 = []byte{
	...
	,
}
...
func (m *MsgWithdrawCSR) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.CsrPools) > 0 {
		for iNdEx := len(m.CsrPools) - 1; iNdEx >= 0; iNdEx-- {
			{
				size := m.CsrPools[iNdEx].Size()
				i -= size
				if _, err := m.CsrPools[iNdEx].MarshalTo(dAtA[i:]); err != nil {
					return 0, err
				}
				i = encodeVarintTx(dAtA, i, uint64(size))
			}
...
func (m *MsgWithdrawCSR) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 1:
			...
			m.CsrPools = append(m.CsrPools, v)
			if err := m.CsrPools[len(m.CsrPools)-1].Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		case 2:
