...
type QueryCSRRequest struct {
	...
	PoolAddress github_com_cosmos_cosmos_sdk_types.AccAddress `protobuf:"bytes,1,opt,name=pool_address,json=poolAddress,proto3,customtype=github.com/cosmos/cosmos-sdk/types.AccAddress" json:"pool_address"`
}
...
type QueryUserToCSRRequest struct {
	...
	AccAddress github_com_cosmos_cosmos_sdk_types.AccAddress `protobuf:"bytes,1,opt,name=acc_address,json=accAddress,proto3,customtype=github.com/cosmos/cosmos-sdk/types.AccAddress" json:"acc_address"`
}
...
func (m *QueryRewardsRequest) GetAccAddress() string {
	if m != nil {
		return m.AccAddress
	}
	return ""
...
var fileDescriptor_a845ddc1dc245388 = []byte{
	...
	,
}
...
func (m *QueryUserToCSRRequest) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	_ = l
	{
		size := m.AccAddress.Size()
		i -= size
		if _, err := m.AccAddress.MarshalTo(dAtA[i:]); err != nil {
			return 0, err
		}
		i = encodeVarintQuery(dAtA, i, uint64(size))
	}
...
func (m *QueryUserToCSRRequest) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 1:
			...
			if err := m.AccAddress.Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		default:
