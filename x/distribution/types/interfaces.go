...
type BankKeeper interface {
	...
	// for burning of the baseFee in allocation.go
...
// Expected interface from ethermint's feemarket module for use in burning the baseFeePerBlock in each BeginBlock

type FeeMarketKeeper interface {
	// returns the BaseFeePerBlock
	GetBaseFee(ctx sdk.Context) *big.Int
	// returns the total Gas Used for the parent Block
