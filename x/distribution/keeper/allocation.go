...
func (k Keeper) AllocateTokens(
	...
	//calculate baseFeeBurned
	parentGasUsed := sdk.NewDec(int64(k.feemarketKeeper.GetBlockGasWanted(ctx)))
	parentBaseFee := sdk.NewDecFromBigInt(k.feemarketKeeper.GetBaseFee(ctx))
	// parentBaseFee is of type *big.Int, so we must use the native .Mul() operation
