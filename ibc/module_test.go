...
func (m MockIBCModule) OnChanOpenInit( //nolint:govet // this is a test and we are ok with copying locks
	ctx sdk.Context,
...
func (m MockIBCModule) OnChanOpenTry( //nolint:govet // this is a test and we are ok with copying locks
	ctx sdk.Context,
	order channeltypes.Order,
	connectionHops []string,
	portID,
...
func (m MockIBCModule) OnChanOpenAck( //nolint:govet // this is a test and we are ok with copying locks
	ctx sdk.Context,
	portID,
	channelID,
...
func (m MockIBCModule) OnChanOpenConfirm( //nolint:govet // this is a test and we are ok with copying locks
	ctx sdk.Context,
	portID,
	channelID string,
) error {
...
func (m MockIBCModule) OnChanCloseInit( //nolint:govet // this is a test and we are ok with copying locks
	ctx sdk.Context,
	portID,
	channelID string,
) error {
...
func (m MockIBCModule) OnChanCloseConfirm( //nolint:govet // this is a test and we are ok with copying locks
	ctx sdk.Context,
	portID,
	channelID string,
) error {
...
func (m MockIBCModule) OnRecvPacket( //nolint:govet // this is a test and we are ok with copying locks
	ctx sdk.Context,
...
func (m MockIBCModule) OnAcknowledgementPacket( //nolint:govet // this is a test and we are ok with copying locks
	ctx sdk.Context,
	packet channeltypes.Packet,
...
func (m MockIBCModule) OnTimeoutPacket( //nolint:govet // this is a test and we are ok with copying locks
	ctx sdk.Context,
	packet channeltypes.Packet,
	relayer sdk.AccAddress,
) error {
